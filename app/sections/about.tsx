    ...
    <section className="min-h-screen bg-gradient-to-b from-white to-gray-100 dark:from-black dark:to-gray-900 py-12 md:py-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
        ...
        <CardContainer className="inter-var">
          <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-purple-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full max-w-[30rem] h-auto rounded-xl p-4 md:p-6 border">
          <CardItem
            translateZ={50}
          ...
          <CardItem translateZ={100} className="w-full mt-4">
            <Image
            src="/images/innovation-hub.jpg" // Add your actual image
            height={400}
            width={800}
        ...
        <p className="text-lg md:text-xl lg:text-3xl text-neutral-500 dark:text-neutral-400 max-w-3xl text-left mb-8 md:mb-10">
          ...
          <LinkPreview
          url="/programs"
          imageSrc="/benefits/1.png" // Add your actual image
          isStatic={true}
        ...
        <p className="text-lg md:text-xl lg:text-3xl text-neutral-500 dark:text-neutral-400 max-w-3xl text-left">
          ...
          <LinkPreview
          url="/mentors"
          imageSrc="/images/mentors.jpg" // Add your actual image
          isStatic
          className="font-bold"
          >
          Expert Mentors
          ...
          <LinkPreview
          url="/resources"
          imageSrc="/images/resources.jpg" // Add your actual image
          isStatic
          className="font-bold"
          >
          Resource Network
